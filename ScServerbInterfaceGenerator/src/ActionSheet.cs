...
namespace ScServerInterfaceGenerator
{
	public class ActionSheet : XlsElement
	{
		...
		private void GenerateRequestClass(string directory)
		{
			...
			//sb.AppendLine("using Sc.Multi.Web;");
			sb.AppendLine();
			...
			sb.AppendLine(Tab + "public class " + ActionName + "Request");
			sb.AppendLine(Tab + "{");
		...
		private void GenerateResponseClass(string directory)
		{
			...
			sb.AppendLine("{");
			sb.AppendLine(Tab + "/// <summary>");
			sb.AppendLine(Tab + "/// " + ActionSummary + "レスポンス");
			sb.AppendLine(Tab + "/// </summary>");
			//sb.AppendLine(Tab + "[Serializable]");
			sb.AppendLine(Tab + "public class " + ActionName + "Response");
			sb.AppendLine(Tab + "{");
		...
		private void GenerateActionClass(string directory)
		{
			...
			sb.AppendLine(Tab + "/// </summary>");
            //sb.AppendLine(Tab + "[Serializable]");
            //sb.AppendLine(Tab + "public class " + ActionName + "Action : MultiActionBase<" + ActionName + "RequestKey, " + ActionName + "ResponseKey>");
            sb.AppendLine(Tab + "public class " + ActionName + "Action : MultiActionBase<" + ActionName + "Request, " + ActionName + "Response>");
            sb.AppendLine(Tab + "{");

			sb.AppendLine(Tab + Tab + "/// <summary>URL</summary>");
			sb.AppendLine(Tab + Tab + "protected override string Url { get { return MultiActionUrlConst.Url" + ActionName + "; } }");
			sb.AppendLine();
//			sb.AppendLine(Tab + Tab + "/// <summary>暗号化キー</summary>");
//			sb.AppendLine(Tab + Tab + "protected override string CipherKey { get { return ConnectKeyServerConst.Atk" + ActionName + "; } }");
			//sb.AppendLine();
            ...
            //sb.AppendLine(Tab + Tab + Tab + "_request = new MultiRequestBase<" + ActionName + "RequestKey>()");
            sb.AppendLine(Tab + Tab + Tab + "_request = new MultiRequestBase<" + ActionName + "Request>()");
            sb.AppendLine(Tab + Tab + Tab + "{");
			sb.AppendLine(Tab + Tab + Tab + Tab + "T_MULTI_REQUEST_HEADER = new TMultiRequestHeader()");
			sb.AppendLine(Tab + Tab + Tab + Tab + "{");
			sb.AppendLine(Tab + Tab + Tab + Tab + Tab + "P_ACTION_TYPE = MultiConnectKeyConst.At" + ActionName);
			sb.AppendLine(Tab + Tab + Tab + Tab + "},");
			sb.AppendLine(Tab + Tab + Tab + Tab + "T_BODY = new " + ActionName + "Request()");
			sb.AppendLine(Tab + Tab + Tab + Tab + "{");
